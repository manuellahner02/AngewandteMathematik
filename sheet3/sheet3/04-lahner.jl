...
f(x, y) = x^2 + 2*y^2
f_gradient(x, y) = [2*x, 4*y]

g(x, y) =  sin(x)^2+ 7/5*cos(y)+1/3*y
g_gradient(x, y) = [2*cos(x)*sin(x), -7/5*sin(y)+1/3]

h(x, y) = 4*x^2*exp(-x^2-y^2)+4*y^2*exp(-x^2-y^2) 
h_gradient(x, y) = [8*x*exp(-x^2-y^2)+4*x^2*(-2*x*exp(-x^2-y^2))+4*y^2*(-2*x*exp(-x^2-y^2)), 8*y*exp(-x^2-y^2)+4*x^2*(-2*y*exp(-x^2-y^2))+4*y^2*(-2*y*exp(-x^2-y^2))]
